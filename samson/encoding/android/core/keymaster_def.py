# https://android.googlesource.com/platform/frameworks/base/+/45ff13e/core/java/android/security/keymaster/KeymasterDefs.java
# DEFINITIVE: https://android.googlesource.com/platform/hardware/libhardware/+/refs/heads/main/include_all/hardware/keymaster_defs.h
from enum import Enum

def remove_tag_type(tag):
    return tag & 0x0FFFFFFF


# Defined just for ease of ues in KMTag
KM_INVALID = 0 << 28
KM_ENUM = 1 << 28
KM_ENUM_REP = 2 << 28
KM_UINT = 3 << 28
