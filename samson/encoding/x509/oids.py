...
class StandardExtensionType(_OID, metaclass=OIDEnumMeta):
    ...
    OBSOLETE_KEY_USAGE_RESTRICTION    = '2.5.29.4'
    OBSOLETE_POLICY_MAPPING      = '2.5.29.5'
    OBSOLETE_SUBTREES_CONSTRAINT = '2.5.29.6'
    OBSOLETE_SUBJECT_ALT_NAME    = '2.5.29.7'
    OBSOLETE_ISSUER_ALT_NAME     = '2.5.29.8'
    SUBJECT_DIRECTORY_ATTRIBUTES = '2.5.29.9'
    OBSOLETE_BASIC_CONSTRAINTS   = '2.5.29.10'
    ...
    OBSOLETE_EXPIRATION_DATE     = '2.5.29.22'
    HOLD_INSTRUCTION_CODE        = '2.5.29.23'
    INVALIDITY_DATE              = '2.5.29.24'
    OBSOLETE_CRL_DISTRIBUTION_POINTS    = '2.5.29.25'
    OBSOLETE_ISSUING_DISTRIBUTION_POINT = '2.5.29.26'
