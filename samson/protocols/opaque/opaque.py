...
class OPAQUEClient(OPAQUE):
    ...
    def RecoverCredentials(self, password, blind, response, server_identity, client_identity):
        evaluated_element = self.G.DeserializeElement(response.evaluated_message)
...
class AKEServer(object):
    ...
    def GenerateKE2(self, server_identity, server_private_key, server_public_key, record, credential_identifier, oprf_seed, ke1, client_identity, masking_nonce=None, server_nonce=None, server_keyshare_seed=None):
