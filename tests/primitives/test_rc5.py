...
class RC5TestCase(unittest.TestCase):
    ...
    def test_zfill(self):
        ...
        plaintext = Bytes(b'', 'little').zfill(8)
    ...
    def test_vec1(self):
        ...
        plaintext   = Bytes(0x00010203, 'little').zfill(4)[::-1]
        test_vector = Bytes.wrap(0x23A8D72E, 'little').zfill(4)[::-1]
    ...
    def test_vec2(self):
        ...
        plaintext = int.to_bytes(0x0001020304050607, 8, 'little')[::-1]
        test_vector = Bytes.wrap(0x2A0EDC0E9431FF73, 'little').zfill(8)[::-1]
    ...
    def test_vec3(self):
        ...
        plaintext = int.to_bytes(0x000102030405060708090A0B0C0D0E0F, 16, 'little')[::-1]
        test_vector = Bytes.wrap(0xA46772820EDBCE0235ABEA32AE7178DA, 'little').zfill(16)[::-1]
